    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3 no-print">
                ...
                <button onclick="downloadPDF('Monthly Correspondence Summary')"
                    ...
                    <table class="report-table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-left">User Name / Designation</th>
                        ...
                        <tbody>
                            @foreach($summary as $index => $row)
                                <tr>
                                    ...
                                    <td class="text-left">
                                        {{ $row->currentHolder?->name ?? 'N/A' }}<br>
                                        <span
                                            class="text-[10px] text-gray-500 italic">{{ $row->currentHolder?->designation ?? '' }}</span>
                                    </td>
                                    <td class="font-bold text-lg text-blue-600">{{ $row->total }}</td>
                                </tr>
                            @endforeach
                        </tbody>
