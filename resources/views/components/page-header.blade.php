...
@php
    // Determine the back URL - support both route names and direct URLs
    $backHref = $backUrl ?? (str_starts_with($backRoute, 'http') || str_starts_with($backRoute, '/') ? $backRoute : route($backRoute));
@endphp
